...
var firebaseConfigPath = Path.Combine(builder.Environment.ContentRootPath, "firebase-adminsdk.json");
...
{
    throw new FileNotFoundException("Firebase configuration file not found. Please ensure firebase-adminsdk.json is present in the project root.");
}
