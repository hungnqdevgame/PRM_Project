...
public partial class SalesAppDBContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CartId).HasName("PK__Carts__51BCD7979B2537B2");
        ...
        {
            entity.HasKey(e => e.CartItemId).HasName("PK__CartItem__488B0B2ABDBF0EDE");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Categori__19093A2BA2C6E6FA");
        ...
        {
            entity.HasKey(e => e.ChatMessageId).HasName("PK__ChatMess__9AB61055D9E2B557");
        ...
        {
            entity.HasKey(e => e.NotificationId).HasName("PK__Notifica__20CF2E327174F97B");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__Orders__C3905BAF98F93DA0");
        ...
        {
            entity.HasKey(e => e.PaymentId).HasName("PK__Payments__9B556A5821CB8DF4");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Products__B40CC6EDCBA743C3");
        ...
        {
            entity.HasKey(e => e.LocationId).HasName("PK__StoreLoc__E7FEA477C471C030");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__1788CCAC56D35971");
